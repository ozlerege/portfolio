  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-28 left-28 w-88 h-88 bg-gray-900 rounded-full blur-3xl"></div>
        <div className="absolute bottom-28 right-28 w-80 h-80 bg-gray-800 rounded-full blur-3xl"></div>
      </div>
          ...
          {recentPosts.length > 0 ? (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {recentPosts.map(({ id, date, title, excerpt }, index) => (
                <article
                  key={id}
                  className="group bg-black border-2 border-white rounded-lg shadow-lg hover:shadow-xl p-8 space-y-6 hover:scale-105 transition-all duration-300 animate-fade-in-up flex flex-col"
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="p-2 bg-white rounded-professional group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex-grow space-y-4">
                    <h3 className="text-xl font-bold text-white group-hover:text-gradient transition-colors leading-tight">
                  ...
                  <div className="pt-4 border-t border-gray-700">
                    <Link 
                      href={`/blog/${id}`}
                      className="inline-flex items-center gap-2 text-white hover:text-gray-300 font-medium transition-colors group/link"
                    >
            ...
            <div className="text-center space-y-4 animate-fade-in-up">
              <div className="p-8 bg-black border-2 border-white rounded-lg shadow-lg max-w-md mx-auto">
                <div className="w-16 h-16 bg-gray-800 border-2 border-white rounded-full flex items-center justify-center mx-auto mb-4">
